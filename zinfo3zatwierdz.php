	...
	if(isset($_POST['wybierz2'])) {
		...
		try {
			...
			if($polaczenie->connect_errno!=0)	{
				...
				$cv_info = "SELECT id, naglowek, info FROM info WHERE id_usera='$id' AND naglowek='$wybierz2'";
...
<html lang="pl">
	...
	<body>
		...
		<div id = "C">CVcmd:\<?php echo $_SESSION['user']?>\zinfo\zatwierdz&gt; <input type="text" id="Commands" name="koniec" autocomplete="off" class="mousetrap"/>
		</form>
