<?php
	...
	if(isset($_POST['email'])) {
		...
		if ($back_or_exit == "") {
			$_SESSION['error_dane'] ='CVcmd:\\' . $_SESSION['user'] . '\+dane\e-mail&gt;</br><span style="color:red">Podaj dane</span></br></br>';
...
<html lang="pl">
	...
	<body>
		...
		<form method="post" action="dodaj_dane6zatwierdz.php">
			<div id = "C">CVcmd:\<?php echo $_SESSION['user']?>\+dane\data urodzenia&gt;<input type="text" id="Commands" name="data_urodzenia" autocomplete="off" class="mousetrap"/>
		</form>
